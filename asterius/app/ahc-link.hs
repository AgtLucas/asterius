...
genNode ffi_state LinkReport {..} m_path =
  mconcat
    ...
    , ", __asterius_traceCmm: f => console.log(\"[INFO] Entering \" + func_syms[f-1] + \", Sp: 0x\" + i.exports.__asterius_Load_Sp().toString(16).padStart(8, \"0\") + \", SpLim: 0x\" + i.exports.__asterius_Load_SpLim().toString(16).padStart(8, \"0\") + \", Hp: 0x\" + i.exports.__asterius_Load_Hp().toString(16).padStart(8, \"0\") + \", HpLim: 0x\" + i.exports.__asterius_Load_HpLim().toString(16).padStart(8, \"0\"))"
    , ", __asterius_traceCmmBlock: (f, lbl) => console.log(\"[INFO] Branching to \" + func_syms[f-1] + \" basic block \" + lbl + \", Sp: 0x\" + i.exports.__asterius_Load_Sp().toString(16).padStart(8, \"0\") + \", SpLim: 0x\" + i.exports.__asterius_Load_SpLim().toString(16).padStart(8, \"0\") + \", Hp: 0x\" + i.exports.__asterius_Load_Hp().toString(16).padStart(8, \"0\") + \", HpLim: 0x\" + i.exports.__asterius_Load_HpLim().toString(16).padStart(8, \"0\"))"
    , ", __asterius_traceCmmSetLocal: (f, i, lo, hi) => console.log(\"[INFO] In \" + func_syms[f-1] + \", Setting local register \" + i + \" to 0x\" + newI64(lo, hi).toString(16).padStart(8, \"0\"))"
  ...
  let (!m_final_m, !report) =
        ...
        if debug
          then [ "__asterius_Load_Sp"
               ...
               , "__asterius_Load_F64"
               , "__asterius_Store_I8"
               , "__asterius_Store_I16"
               , "__asterius_Store_I32"
               , "__asterius_Store_I64"
               , "__asterius_Store_F32"
               , "__asterius_Store_F64"
               ]
          else []
  maybe
    (pure ())
